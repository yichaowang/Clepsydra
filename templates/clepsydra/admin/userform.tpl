{% if (person=="") %} {% set role = 'create' %} {% endif %}
...
<form class="userform" action="{{ 'clepsydra:admin/edit' | url }}" id="userform-create" method="post">
	<fieldset>
		...
		<ul>
			<li> 
				<label>Name</label>
				<input id="uname" name="uname" type="text" size="20" value=""/>
			</li>
			<li> 
...
<form class="userform" action="{{ 'clepsydra:admin/edit' | url }}" id="userform-update" method="post">
	<fieldset>
		<div class="title">Editing {{person.name}}'s profile:</div>
			...
			<li> 
				<label for="password">Password</label> 
				<a class="inform-button s-button pw-update">Click to update</a>
			</li>
			...
			<li>
				<a class="del-button s-button">Delete User</a>
			</li>
